package visualGraph.test;
import java.io.File;
import junit.framework.*;
import visualGraph.src.MySearcher;
...
public class MySearcherLatexTest extends TestCase {
   ...
   public void testBreadthFirst() {
      ...
      for (int i = 0; i < from.length; i++) {
         ...
         my.setMap(new File("/home/deamoon/Documents/programming/trash/Graph/src/visualGraph/maps/umea_map.xml"));
